...
const crimeaSource: GeoJSONSourceSpecification = {
  type: "geojson",
  data: {
    type: "Feature",
    geometry: {
...
const lightLayers: LayerSpecification[] = [
  {
    id: "background",
    type: "background",
    maxzoom: 24,
  ...
  },
  {
    ...
    paint: {
      ...
      "line-opacity": ["interpolate", ["linear"], ["zoom"], 3, 0.5, 6, 1],
    },
  },
  {
    id: "geolines",
  ...
  },
  {
    ...
    paint: {
      ...
      "text-halo-blur": ["interpolate", ["linear"], ["zoom"], 2, 0.2, 6, 0],
      "text-halo-color": "rgba(255, 255, 255, 1)",
      "text-halo-width": ["interpolate", ["linear"], ["zoom"], 2, 1, 6, 1.6],
    },
  },
  {
    id: "crimea-fill",
...
const darkLayers: LayerSpecification[] = [
  {
    id: "background",
    type: "background",
    maxzoom: 24,
    layout: { visibility: "visible" },
    paint: { "background-color": "#1B263B" },
  },
  {
    id: "coastline",
    type: "line",
  ...
  },
  {
    ...
    paint: {
      "text-color": "#4A90E2",
      "text-halo-blur": 1,
      "text-halo-color": "rgba(56, 56, 56, 1)",
      "text-halo-width": 1,
    },
  },
  {
...
const baseStyle: StyleSpecification = {
  ...
  sources: {
    maplibre: {
      ...
      type: "vector",
      attribution: 'attribution : <a href="https://maplibre.org/">MapLibre</a>',
    },
    crimea: crimeaSource,
  },
  layers: [],
